...
NAI = {
	...
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 40, -- AI penalty for diplomatic faction acitons between nations of different ideologies
	...
	DIPLOMACY_LEAVE_FACTION_OPINION_FACTOR = 1.0,-- How much the opinion of countries being targeted by faction leader matters when deciding to leave a faction (democratic only)
