...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1910.4.10.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NAir = {
	...
	ACCIDENT_CHANCE_CARRIER_MULT = 0.5,					-- The total accident chance is scaled up when it happens on the carrier ship.
